function [p, settings] = meanreversion(DATE, OPEN, HIGH, LOW, CLOSE, VOL, exposure, equity, settings)
...
settings.markets     = {'CASH', 'AMZN', 'AAPL', 'ORCL', 'MSFT' };
%, 'F_CC', 'F_CD', 'F_CL', 'F_CT', 'F_DX', 'F_EC', 'F_ED', 'F_ES', 'F_FC', 'F_FV', 'F_GC', 'F_HG', 'F_HO', 'F_JY', 'F_KC', 'F_LB', 'F_LC', 'F_LN', 'F_MD', 'F_MP', 'F_NG', 'F_NQ', 'F_NR', 'F_O', 'F_OJ', 'F_PA', 'F_PL', 'F_RB', 'F_RU', 'F_S', 'F_SB', 'F_SF', 'F_SI', 'F_SM', 'F_TU', 'F_TY', 'F_US', 'F_W', 'F_XX', 'F_YM'};
...
short  = smaQuot == max(smaQuot);
long   = smaQuot == min(smaQuot);
